use crate::{
    AnimationRegistration, AnimationTargetId, Duration, RouteTransition,
    RouteTransitionRegistration, Timeline,
};
    ...
    R: Copy + Eq,
{
    ...
    #[must_use]
    pub fn outgoing_finishes_before_incoming_final(&self) -> Option<bool> {
